...
- **005-openclaw-reviewer** — Re-check (2026-03-22T22:23Z): sibling `../openclaw` pinned at `HEAD` `95ae8aa`; `AGENTS.md` still matches `package.json`, Vitest thresholds, and `src/`; table row 2 notes `src/routing/` on disk. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **006-feature-coder** — Backlog rows for FEAT-D167 through FEAT-D186 (HTML `clean_html` / FETCH_URL Unicode arms). (`006-feature-coder/FEATURE-CODER.md`.)
