...
### Documentation
- **FEATURE-CODER backlog (FEAT-D41–D43)** — Table rows for completed FETCH_URL `clean_html` work: U+202A–U+202E bidi embedding/override, variation selectors (U+FE00–U+FE0F, U+E0100–U+E01EF) plus Mongolian U+180B–U+180E, and Unicode Tags U+E0000–U+E007F. (`006-feature-coder/FEATURE-CODER.md`.)
