...
### Documentation
- **FEATURE-CODER backlog (FEAT-D41–D46)** — Table rows for completed FETCH_URL `clean_html` work: U+202A–U+202E bidi embedding/override, variation selectors (U+FE00–U+FE0F, U+E0100–U+E01EF) plus Mongolian U+1806/U+180A/U+180B–U+180E, Unicode Tags U+E0000–U+E007F, Khmer inherent vowels U+17B4/U+17B5, and Arabic/Syriac edition format controls U+0600–U+0605 / U+06DD / U+070F / U+08E2. (`006-feature-coder/FEATURE-CODER.md`.)
