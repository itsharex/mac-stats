...
- **005-openclaw-reviewer** — Evening re-check (2026-03-22T22:00Z): sibling `../openclaw` pinned at `HEAD` `95ae8aa`; `AGENTS.md` still matches `package.json`, Vitest thresholds, and `src/`. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **006-feature-coder** — Backlog rows for FEAT-D167 through FEAT-D171 (HTML `clean_html` / FETCH_URL Unicode arms). (`006-feature-coder/FEATURE-CODER.md`.)
