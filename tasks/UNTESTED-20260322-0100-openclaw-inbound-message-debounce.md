...
- **Next step:** Tester runs **§4 Testing instructions** below; live Discord multi-message merge and shutdown discard still need operator or staging. Older closure notes remain in `tasks/CLOSED-20260322-0100-openclaw-inbound-message-debounce.md`.
---
