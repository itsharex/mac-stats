...
| task-008 | Overnight plan: request isolation, search hardening, compaction safety | plan — Phase 1 done (RequestRunContext, request_id_override, retry_count; same request_id on verification retry). Phases 2–7 in worklist. |
